...
function clickLogout() {
	var res = confirm("Click Ok to logout");
	if( res == true)
		{
...
label { display: inline-block; width: 200px; text-align: center; font-family: "Times New Roman", Times, serif; font-size:26px; }
...
<h1>Gift Store</h1>
<button type="submit" class="logoutbtn" onClick="javascript:clickHome()">Home</button> 
<button type="submit" class="logoutbtn" onClick="javascript:clickLogout()">Logout</button> 
</header>
</article>
<div>
<form action="addprod.do" method="post">
<h2>Enter Details</h2><br>
<label> Product Id </label>   
<input type="number" name="pid" placeholder= "ProductId" required /> <br>
<label> Product name </label>   
<input type="text" name="pname" placeholder= "Product Name"  required /> <br>
<label> Product Quantity </label>   
<input type="number" name="pquantity" placeholder= "Quantity"  required /> <br>
<label> Product Price </label>   
<input type="number" name="pprice" placeholder= "Price"  required /> <br>

<button type="submit" class="logbtn">Add Product</button>
