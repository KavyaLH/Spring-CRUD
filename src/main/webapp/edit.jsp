...
<h1>Gift Store</h1>
<!-- <input type="submit" class = "logoutbtn" onClick="javascript:clickinner()" value="Register"> -->
...
<div>
<form action="edittab.do"> 
<label>Enter Email ID to view data </label>   
<input type="email" name="useremail" placeholder= "Email"  required /> <br>
<button type="submit" class="logbtn">Get Details</button>  
<button type="submit" class="logbtn">Cancel</button>  
